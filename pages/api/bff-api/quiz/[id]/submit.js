...
async function handlePost(req, res) {
    ...
    const fhirQuestionnaireResponse = mapRJSFResponseToFHIR(req.body, id, fhirQuestionnaire);
    
    const fhirResponse = await createResource("QuestionnaireResponse", fhirQuestionnaireResponse);
